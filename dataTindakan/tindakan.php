...
$containerAkun = query("SELECT * FROM tindakan");
...
<html>
  ...
  <body>
    ...
    <h1 class="mx-2 text-center">Dashboard Data Tindakan Kepada Pasien</h1>
          ...
          <?php foreach($containerAkun as $akun){ ?>
            <tbody>
                <tr>
                  ...
                  <td><?php echo $akun["tindakan"] ?></td>
                  <td><?php echo $akun["biayatindakan"] ?></td>
